          ...
          {filtered.map((pkg) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <a
                  href="#kontakt"
                  className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full border-2 border-sky-400 bg-white px-5 py-3 text-sm font-semibold text-sky-600 transition hover:bg-sky-500 hover:text-white"
                >
                  Sprawdź dostępność
